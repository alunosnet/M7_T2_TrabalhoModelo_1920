...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div runat="server" id="divLogin" class="col-md-3 float-right border">
        ...
        Password:<asp:TextBox CssClass="form-control" TextMode="Password" ID="TBPassword" runat="server"></asp:TextBox><br />
        <asp:Button CssClass="btn btn-info" ID="Button1" runat="server" Text="Login" />
        <asp:Label CssClass="alert-danger" ID="Label1" runat="server" Text=""></asp:Label>
    ...
    <div runat="server" id="divCursos" class="col-md-9 float-left border">
        ...
        <asp:GridView CssClass="table" ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlCursos">
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="curso" DataNavigateUrlFormatString="detalhes_curso.aspx?q={0}" Text="Ver mais..." HeaderText="Detalhes do curso"></asp:HyperLinkField>
            </Columns>
        </asp:GridView>
